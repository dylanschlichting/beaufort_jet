...
if [ -n "${ROMS_ROOT_DIR:+1}" ]; then
  export      MY_ROOT_DIR=/pscratch/sd/d/dylan617/roms # ${ROMS_ROOT_DIR} 
else
  export      MY_ROOT_DIR=/pscratch/sd/d/dylan617/roms # ${HOME}/ocean/repository/git 
fi

export     MY_PROJECT_DIR=/global/homes/d/dylan617/beaufort_jet/project # ${PWD} 
...
# computers.
 ...
 export       MY_ROMS_SRC=/pscratch/sd/d/dylan617/roms # ${MY_ROOT_DIR}/roms 
